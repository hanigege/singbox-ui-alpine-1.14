const translations = {
  en: {
    ...
    localDnsEcsNote: "Attach an EDNS Client Subnet to domestic DNS queries. Authoritative DNS returns CDN IPs closest to this subnet. Leave blank to disable ECS (upstream DNS uses your egress IP automatically). Must be a network CIDR, NOT a single IP. Example: '118.184.0.0/15' for Xuzhou Telecom. Do NOT use your real IP for privacy.",
  ...
  zh: {
    ...
    localDnsEcsNote: "为国内 DNS 查询附加 EDNS Client Subnet，权威 DNS 按该网段返回就近 CDN IP。留空 = 不启用 ECS（上游 DNS 按出口 IP 自动判断，适合出口 IP 稳定的家庭宽带）。必须填写网段，不能填单 IP。示例：「118.184.0.0/15」代表徐州电信。请勿填写真实 IP 以保护隐私。",
